...
class Form {
  ...
  //SIGN UP
      button1.mousePressed(function(){
        ...
        submit.mousePressed(function(){
          ...
          con.position(displayWidth/2, displayHeight/2-50);
          con.mousePressed(()=>{
        ...
        if(count===undefined){
           ...
           user.email = email.value();
            ...
            user.updateCount(userCount);
             ...
             greeting.position(displayWidth/2+50, displayHeight/2-150)          
            
    
    
        var con= createButton('CONTINUE');
        con.position(displayWidth/2+100, displayHeight/2-100);
        con.mousePressed(()=>{
 ...
 email1.hide();
        ...
        greeting.position(displayWidth/2+100, displayHeight/2)
        con.position(displayWidth/2+150, displayHeight/2+200);
        con.mousePressed(()=>{
